...
search_params = {"query": sys.argv[1], "scope": "Sample", "offset": 0,
                 "max": 3, "multipleCategories": True}

command = "curl -X POST -d '{}' -u {}:{} {}/clarity/api/search".format(search_params, USERNAME, PASSWORD, BASEURI)
